...
- **p169**{: .calculus-teal} 1–6, 7–33 odd, 41, 45, 49, 53, 57, 61, 65, 69, 73, 77, 81, 85, 89, 93, 97, 99–102, 104, 105, 108, 110, 112, 115, 117, 119, 120, 127, 130, 131, 133, 141, 143, 159–164, 167, 193–195 (51 problems)
...
$$\begin{align}
\frac{d}{dx}[a^x] &= \frac{d}{dx}[e^{(\ln a)x}] \\[0.5em]
                  &= e^{(\ln a)x} \cdot \ln a   \\[0.5em]
                  &= a^x \cdot \ln a \\[0.5em]
...
$$\begin{align}
\frac{d}{dx}[\log_a x] &= \frac{d}{dx}\left[\frac{1}{\ln a} \ln x\right] \\[0.5em]
                       &= \frac{1}{(\ln a) x}
\end{align}$$
