...
But in other cases, you can run into horizontal asymptotes. You might remember these from Algebra 2, and that there were some tricks to spotting these without going through the trouble of graphing or substituting values, though these only work with rational functions.
