...
This is a strategy for differentiating functions that would otherwise involve a heavy use of product or quotient rule. It makes use of the fact that

$$ \ln\left(ab\right) = \ln a + \ln b \qquad \ln\left(\frac{a}{b}\right) = \ln a - \ln b $$

We'll cover some examples in class, but using this is a personal preference and it is not directly tested on the AP exam.
