...
Note that last step is explicitly defining the derivative by isolating $\frac{dy}{dx}$. There's a general strategy on page 175 in the book that I'll include here.
