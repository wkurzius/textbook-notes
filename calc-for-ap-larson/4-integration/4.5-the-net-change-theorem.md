...
And with the lid of the calculator thing, using absolute value will give you total distance traveled without needing to find the zeros and splitting the integral.

$$\begin{align}
\int_1^5 \left|t^3 -10t^2 + 29t - 20\right| \, dt &= 11.8\overline{3}
\end{align}$$
