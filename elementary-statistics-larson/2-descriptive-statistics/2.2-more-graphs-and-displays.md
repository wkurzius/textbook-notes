...
Vocabulary words: **8** | [Slideshow version](https://1drv.ms/p/s!ApcrauBhfAnEj-ldFoPtyVTCjwAK-A?e=47V4GS)
...
A common version of this is a **time series**, where data is recorded at regular intervals. Below is an example of annual record of the number of cell phone subscribers from 2002–2012.

<center><img src="../img/2.2-time-series.png" width="400" alt="Pareto chart"></center>

[^1]: It's named after the Pareto principle. It's an efficiency principle and is also known as the 80/20 rule, which states that 80% of consequences come from 20% of the causes. Its namesake comes from an Italian polymath (someone who studied many topics) who noted the phenomenon.
