...
A Pareto* chart (named after the efficiency principle, which in turn was named after an Italian polymath)

\* It's named after the Pareto principle. It's an efficiency principle and is also known as the 80/20 rule, which states that 80% of consequences come from 20% of the causes. Its namesake comes from Italian polymath (someone who studied many topics) who noted the phenomenon.