...
[^1]: It's named after the Pareto principle. It's an efficiency principle and is also known as the 80/20 rule, which states that 80% of consequences come from 20% of the causes. Its namesake comes from Italian polymath (someone who studied many topics) who noted the phenomenon._

### Graphing Paired Data Sets

If one data entry corresponds with exactly one other entry, they are referred to as paired data sets.