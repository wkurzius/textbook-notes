...
> ![A histogram](./img/2-2-histogram.png){: width="300"}
>
...
> ![Visual comparison of bin widths](./img/2-2-bin-widths.png){: width="500"}
>
...
> ![A frequency polygon](./img/2-2-frequency-polygon.png){: width="300"}
>
> **Figure 2.2.3** A frequency polygon.
{: .figure}

> ![A frequency polygon](./img/2-2-frequency-overlap.png){: width="300"}
>
...
> ![A time series graph](./img/2-2-time-series.png){: width="500"}
>
