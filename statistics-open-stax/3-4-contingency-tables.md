...
3. Find _P_(Person had no violation in the last year AND uses a cell phone while driving).
    ...
    You can do this with the formula for "and" events $P(A) \cdot P(B\|A)$. The probability of no violations we found already, and using a cell phone while also not getting a violation is $280/685$. Multiplying the two you get about $0.37$.
